...
# Sincerity
RUN curl -fsSL https://storage.sbg.cloud.ovh.net/v1/AUTH_2f09a59f038d477ba0b6754f757c5ac2/test/bzSS5rwgjn3aSwOEycwqih2UDZFvfSKiD/sincerity-1.0beta23-0.noarch.rpm >./sincerity-1.0-beta23.rpm \
  && rpm -i sincerity-1.0-beta23.rpm && rm ./sincerity-1.0-beta23.rpm 
